...
public class HibernateMain {
	...
	public static void main(String[] args) {
		...
		HibernateMain application = new HibernateMain();
		 ...
		 * Deletes an object
		 */
		application.deleteStudent(studentId1);
	...
	public List<Student> getAllStudents() {
		...
		List<Student> employees = (List<Student>) session.createQuery("FROM Student s ORDER BY s.firstName ASC").list();
